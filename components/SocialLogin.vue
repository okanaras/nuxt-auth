...
<template>
  <div class="my-4 grid grid-cols-3 items-center text-gray-400">
    <hr class="border-gray-400">
    <p class="text-center text-sm">Sosyal medya ile giriş</p>
    <hr class="border-gray-400">
  </div>

  <div class="text-center">

    <button type="button" title="Github ile giriş yap"
    ...
    <button type="button" title="Google ile giriş yap"
